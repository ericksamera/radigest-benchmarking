...
Stage 6 empirical scaffold outputs are currently limited to the tracked manifest
contract and the ignored `results/empirical/` output root:
...
manuscript plots from enabled local BAM rows.
